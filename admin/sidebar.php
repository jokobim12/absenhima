...
<aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-200 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300">
    ...
    <nav class="p-4 space-y-1 overflow-y-auto" style="max-height: calc(100vh - 180px);">
        ...
        <a href="manage_points.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg <?= $current_page == 'manage_points.php' ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100' ?> transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="permissions.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg <?= $current_page == 'permissions.php' ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100' ?> transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="announcements.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg <?= $current_page == 'announcements.php' ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100' ?> transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
